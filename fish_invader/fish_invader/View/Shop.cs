...
namespace fish_invader
{
    public partial class Shop
    {
        ...
        private Image[,] images = new Image[3, 5] 
            {
            {Image.FromFile("images/otherimage/gun.png"), Image.FromFile("images/otherimage/usi.png"), Image.FromFile("images/otherimage/potion.png"), Image.FromFile("images/otherimage/shotgun.png"),Image.FromFile("images/otherimage/missing_texture.png")},
            {Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png")},
            {Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png"), Image.FromFile("images/otherimage/missing_texture.png")},
            };
        ...
        public void Render(BufferedGraphics drawingSpace, Fish fish, List<BadFish> badfleet, List<Jellyfish> jellyfleet)
        {
            ...
            if (Jellyfish.ShopTouch)
            {
                foreach (Jellyfish jellyfish in jellyfleet)
                {
                    ...
                    {
                        fishimage = Image.FromFile($"images/originalfish/jellyf1sh7.png");
            ...
            else
            {
                foreach (BadFish badfish in badfleet)
                {
                    ...
                    {
                        fishimage = Image.FromFile($"images/originalfish/f{badfish.Type}sh7.png");
