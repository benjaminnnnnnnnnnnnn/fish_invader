...
namespace FishInvader
{
    ...
    public partial class AirSpace : Form
    {
        ...
        private void OnKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space)
            {
                if (!TalkingToPng)
                {
                    ...
                    else if (Wepon.wepontype == 1 && !reloding)
                    {
                    ...
                    else if (Wepon.wepontype == 2 && !reloding)
                    {
                        if (progectilcapacity >= 1)
                        {
                            projectiles.Add(new Projectile(fish.X, fish.Y));
                    ...
                    else if (Wepon.wepontype == 3 && !reloding && f == 0)
                    {
                        if (progectilcapacity >= 1)
                        {
        ...
        int rndU = GlobalHelpers.alea.Next(1500, 3000);
        int u = 0;
        int z = 0;
        int h = 0;
        int i;
        private void Update(int interval)
        {
            ...
            if (h == 5)
                h = 0;
            if (Wepon.wepontype == 2 && !reloding && Wepon.hiting && h == 0)
            {
                if (progectilcapacity >= 1)
                {
                    projectiles.Add(new Projectile(fish.X, fish.Y));
